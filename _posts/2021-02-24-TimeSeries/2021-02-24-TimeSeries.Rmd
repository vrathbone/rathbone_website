...
author: 
  - name: Vanessa Rathbone, Hannah Garcia, & Tom Wheeler
date: 02-24-2021
output: 
...
![Sockeye Salmon *(Oncorhynchus nerka)* Credit: Jason Ching/U. Washington](sockeye_salmon1.jpg)

![Credit: US Army Corp of Engineers (link: https://www.nwp.usace.army.mil/willamette/locks/)](Willamette_Falls_Locks_area_map.jpg)
**Figure 1.** Map of Willamette Fish Ladder. 

### Data preparation (Vanessa)
...
fish_main <- read_csv(here("_posts", "2021-02-24-TimeSeries", "willamette_fish_passage.csv")) %>%
  replace(is.na(.), 0) %>%
  clean_names() %>% 
...
#### 2. Data familiarizing and initial plotting
