---
title: "Interactive and Chloropleth Maps"
description: |
  California DWF Oil Spill Incident Tracking Interactive Map and Chloropleth Map.
author:
...
ca_oil <- read_sf(here("_posts", "2021-02-25-Maps", "ds394"), layer = "ds394") %>% 
  clean_names()
...
ca_counties <- read_sf(here("_posts", "2021-02-25-Maps", "ca_counties"), layer = "CA_Counties_TIGER2016") %>% 
  clean_names() %>% 
  select(name)
